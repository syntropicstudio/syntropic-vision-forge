...
export const aboutPeople: AboutPerson[] = [
  ...
  },
  {
    ...
    bio: {
      ...
      en: "At SyntropicStudio, I combine practical IT experience with a human-centered approach to understanding client needs. I enjoy finding simple and functional solutions in areas where technology can save time, make work clearer, or help a business present itself more effectively. I believe that a good website, application, or automation should not be unnecessarily complicated — it should be clear, well thought out, and genuinely useful in real-world use. That is why I approach every project by first understanding its purpose and only then looking for the best path to the final result",
    },
    ico: "23337150",
    initials: "LK",
  },
