...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://www.syntropicstudio.cz/" },
      { property: "og:image", content: "https://www.syntropicstudio.cz/syntropic-mark.png" },
    ...
    links: [
      ...
      { rel: "canonical", href: "https://www.syntropicstudio.cz/" },
